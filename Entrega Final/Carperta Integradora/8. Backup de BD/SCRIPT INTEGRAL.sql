CREATE DATABASE  IF NOT EXISTS `rent_runway` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `rent_runway`;
...
--
-- Table structure for table `clasificacion_prov`
--
...
CREATE TABLE `envios` (
  ...
  `ID_DNI` int DEFAULT NULL,
  `ID_PEDIDOS` int DEFAULT NULL,
  PRIMARY KEY (`ID_ENVIOS`),
  KEY `ID_DNI` (`ID_DNI`),
  KEY `ID_PEDIDOS` (`ID_PEDIDOS`),
  KEY `TIPO_ENVIO` (`TIPO_ENVIO`),
  CONSTRAINT `envios_ibfk_1` FOREIGN KEY (`ID_DNI`) REFERENCES `cliente` (`ID_DNI`),
  CONSTRAINT `envios_ibfk_2` FOREIGN KEY (`ID_PEDIDOS`) REFERENCES `pedidos` (`ID_PEDIDOS`),
  CONSTRAINT `envios_ibfk_3` FOREIGN KEY (`TIPO_ENVIO`) REFERENCES `tipo_envio` (`ID_TIPO_ENVIO`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `log_audita_clas_prov`
--

DROP TABLE IF EXISTS `log_audita_clas_prov`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `log_audita_clas_prov` (
...
--
-- Table structure for table `pedido_vest`
--
...
CREATE TABLE `pedido_vest` (
  `ID_PEDIVEST` int NOT NULL AUTO_INCREMENT,
  `ID_VEST` int DEFAULT NULL,
  `ID_PEDIDO` int DEFAULT NULL,
  PRIMARY KEY (`ID_PEDIVEST`),
  KEY `ID_VEST` (`ID_VEST`),
  KEY `ID_PEDIDO` (`ID_PEDIDO`),
  CONSTRAINT `pedido_vest_ibfk_1` FOREIGN KEY (`ID_VEST`) REFERENCES `vestido_acc` (`ID_VESTIDOS`),
  CONSTRAINT `pedido_vest_ibfk_2` FOREIGN KEY (`ID_PEDIDO`) REFERENCES `pedidos` (`ID_PEDIDOS`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pedidos` (
  ...
  KEY `ID_FC` (`ID_FC`),
  CONSTRAINT `pedidos_ibfk_1` FOREIGN KEY (`ID_CLIENTE`) REFERENCES `cliente` (`ID_DNI`),
  CONSTRAINT `pedidos_ibfk_2` FOREIGN KEY (`TIPO_PEDIDO`) REFERENCES `tipo_pedido` (`ID_TIPO_PEDIDO`),
  CONSTRAINT `pedidos_ibfk_3` FOREIGN KEY (`ID_FC`) REFERENCES `ventas` (`Id_factura`)
...
--
-- Table structure for table `prov_vest`
--
...
CREATE TABLE `prov_vest` (
  `ID_PROVVEST` int NOT NULL AUTO_INCREMENT,
  `ID_VEST` int DEFAULT NULL,
  `ID_PROV` int DEFAULT NULL,
  PRIMARY KEY (`ID_PROVVEST`),
  KEY `ID_VEST` (`ID_VEST`),
  KEY `ID_PROV` (`ID_PROV`),
  CONSTRAINT `prov_vest_ibfk_1` FOREIGN KEY (`ID_VEST`) REFERENCES `vestido_acc` (`ID_VESTIDOS`),
  CONSTRAINT `prov_vest_ibfk_2` FOREIGN KEY (`ID_PROV`) REFERENCES `proveedores` (`iD_PROV`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `proveedores` (
  ...
  CONSTRAINT `proveedores_ibfk_1` FOREIGN KEY (`TIPO_PROVEEDOR`) REFERENCES `clasificacion_prov` (`ID_CLASIFICACION`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `suscripciones` (
  ...
  KEY `ID_DNI` (`ID_DNI`),
  CONSTRAINT `suscripciones_ibfk_1` FOREIGN KEY (`ID_DNI`) REFERENCES `cliente` (`ID_DNI`)
...
--
-- Table structure for table `vestido_acc`
--
...
CREATE TABLE `vestido_acc` (
  `ID_VESTIDOS` int NOT NULL AUTO_INCREMENT,
  `NOMBRE` tinytext NOT NULL,
...
--
-- Temporary view structure for view `vw_catalogo_cliente`
--

DROP TABLE IF EXISTS `vw_catalogo_cliente`;
/*!50001 DROP VIEW IF EXISTS `vw_catalogo_cliente`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_catalogo_cliente` AS SELECT 
 1 AS `ID_DNI`,
 1 AS `NOMBRE`,
 1 AS `APELLIDO`,
 1 AS `DIRECCION`,
...
--
-- Temporary view structure for view `vw_clmasusada`
--

DROP TABLE IF EXISTS `vw_clmasusada`;
/*!50001 DROP VIEW IF EXISTS `vw_clmasusada`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_clmasusada` AS SELECT 
 1 AS `TIPO_PEDIDO`,
 1 AS `CANTIDAD DE PEDIDOS`,
 1 AS `CLASE`,
 1 AS `DESCRIPCION`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vw_clsinpedidos`
--

DROP TABLE IF EXISTS `vw_clsinpedidos`;
/*!50001 DROP VIEW IF EXISTS `vw_clsinpedidos`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_clsinpedidos` AS SELECT 
 1 AS `ID_DNI`,
...
--
-- Temporary view structure for view `vw_diccionario`
--

DROP TABLE IF EXISTS `vw_diccionario`;
/*!50001 DROP VIEW IF EXISTS `vw_diccionario`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_diccionario` AS SELECT 
 1 AS `ID`,
 1 AS `CLASE`,
 1 AS `DESCRIPCION`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `vw_direcciones_cl`
--

DROP TABLE IF EXISTS `vw_direcciones_cl`;
/*!50001 DROP VIEW IF EXISTS `vw_direcciones_cl`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_direcciones_cl` AS SELECT 
 1 AS `Calle`,
 1 AS `Pais`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vw_pedido_cl`
--

DROP TABLE IF EXISTS `vw_pedido_cl`;
/*!50001 DROP VIEW IF EXISTS `vw_pedido_cl`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_pedido_cl` AS SELECT 
 1 AS `ID_CLIENTE`,
 1 AS `Cantidad de pedidos`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vw_pedidotop`
--

DROP TABLE IF EXISTS `vw_pedidotop`;
/*!50001 DROP VIEW IF EXISTS `vw_pedidotop`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_pedidotop` AS SELECT 
 1 AS `ID_CLIENTE`,
 1 AS `Cantidad de pedidos`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vw_top10_deuda`
--

DROP TABLE IF EXISTS `vw_top10_deuda`;
/*!50001 DROP VIEW IF EXISTS `vw_top10_deuda`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_top10_deuda` AS SELECT 
 1 AS `iD_PROV`,
 1 AS `proveedor`,
 1 AS `DEUDA`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `vw_ventas2021`
--

DROP TABLE IF EXISTS `vw_ventas2021`;
/*!50001 DROP VIEW IF EXISTS `vw_ventas2021`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_ventas2021` AS SELECT 
 1 AS `Id_factura`,
 1 AS `fecha_vta`,
 1 AS `facturacion`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `vw_zdeuda`
--

DROP TABLE IF EXISTS `vw_zdeuda`;
/*!50001 DROP VIEW IF EXISTS `vw_zdeuda`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_zdeuda` AS SELECT 
 1 AS `iD_PROV`,
 1 AS `NOMBRE`,
 1 AS `DEUDA`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `vwfacpaez`
--

DROP TABLE IF EXISTS `vwfacpaez`;
/*!50001 DROP VIEW IF EXISTS `vwfacpaez`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vwfacpaez` AS SELECT 
 1 AS `id_factura`,
 1 AS `sum(Monto_Facturado)`*/;
SET character_set_client = @saved_cs_client;

--
-- Final view structure for view `vw_catalogo_cliente`
--
...
/*!50001 VIEW `vw_catalogo_cliente` AS select `cliente`.`ID_DNI` AS `ID_DNI`,`cliente`.`NOMBRE` AS `NOMBRE`,`cliente`.`APELLIDO` AS `APELLIDO`,`cliente`.`DIRECCION` AS `DIRECCION`,`cliente`.`TELEFONO` AS `TELEFONO`,`cliente`.`MAIL` AS `MAIL`,`cliente`.`PAIS` AS `PAIS`,`cliente`.`ANTIGUEDAD` AS `ANTIGUEDAD` from `cliente` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_clmasusada`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_clmasusada` AS select `p`.`TIPO_PEDIDO` AS `TIPO_PEDIDO`,count(`p`.`ID_PEDIDOS`) AS `CANTIDAD DE PEDIDOS`,`t`.`CLASE` AS `CLASE`,`t`.`DESCRIPCION` AS `DESCRIPCION` from (`pedidos` `p` left join `tipo_pedido` `t` on((`t`.`ID_TIPO_PEDIDO` = `p`.`TIPO_PEDIDO`))) where (`t`.`DESCRIPCION` = 'ACTIVO') group by `p`.`TIPO_PEDIDO` order by count(`p`.`ID_PEDIDOS`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_clsinpedidos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_clsinpedidos` AS select `c`.`ID_DNI` AS `ID_DNI`,concat(`c`.`NOMBRE`,' ',`c`.`APELLIDO`) AS `NOMBRE COMPLETO`,count(`p`.`ID_PEDIDOS`) AS `CANTIDAD DE PEDIDOS` from (`cliente` `c` left join `pedidos` `p` on((`c`.`ID_DNI` = `p`.`ID_CLIENTE`))) group by `c`.`ID_DNI` having (count(`p`.`ID_PEDIDOS`) = 0) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_diccionario`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_diccionario` AS select `clasificacion_prov`.`ID_CLASIFICACION` AS `ID`,`clasificacion_prov`.`CLASE` AS `CLASE`,`clasificacion_prov`.`DESCRIPCION` AS `DESCRIPCION` from `clasificacion_prov` union select `tipo_envio`.`ID_TIPO_ENVIO` AS `ID`,`tipo_envio`.`CLASE` AS `CLASE`,`tipo_envio`.`DESCRIPCION` AS `DESCRIPCION` from `tipo_envio` union select `tipo_pedido`.`ID_TIPO_PEDIDO` AS `id`,`tipo_pedido`.`CLASE` AS `CLASE`,`tipo_pedido`.`DESCRIPCION` AS `DESCRIPCION` from `tipo_pedido` order by `ID` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_direcciones_cl`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_direcciones_cl` (`Calle`,`Pais`) AS select `cliente`.`DIRECCION` AS `DIRECCION`,`cliente`.`PAIS` AS `PAIS` from `cliente` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_pedido_cl`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_pedido_cl` AS select `pedidos`.`ID_CLIENTE` AS `ID_CLIENTE`,count(`pedidos`.`ID_PEDIDOS`) AS `Cantidad de pedidos` from `pedidos` group by `pedidos`.`ID_CLIENTE` order by count(`pedidos`.`ID_PEDIDOS`) desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_pedidotop`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_pedidotop` AS select `pedidos`.`ID_CLIENTE` AS `ID_CLIENTE`,count(`pedidos`.`ID_PEDIDOS`) AS `Cantidad de pedidos` from `pedidos` group by `pedidos`.`ID_CLIENTE` having (count(`pedidos`.`ID_PEDIDOS`) > 1) order by count(`pedidos`.`ID_PEDIDOS`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_top10_deuda`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_top10_deuda` AS select `proveedores`.`iD_PROV` AS `iD_PROV`,`proveedores`.`RAZON_SOCIAL` AS `proveedor`,`proveedores`.`saldo` AS `DEUDA` from `proveedores` order by `proveedores`.`saldo` desc limit 10 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_ventas2021`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_ventas2021` AS select `ventas`.`Id_factura` AS `Id_factura`,`ventas`.`fecha_vta` AS `fecha_vta`,sum(`ventas`.`Monto_Facturado`) AS `facturacion` from `ventas` where (`ventas`.`fecha_vta` between '2020-12-31' and '2022-01-01') group by `ventas`.`Id_factura`,`ventas`.`fecha_vta` order by `facturacion` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_zdeuda`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_zdeuda` AS select `proveedores`.`iD_PROV` AS `iD_PROV`,`proveedores`.`RAZON_SOCIAL` AS `NOMBRE`,`proveedores`.`saldo` AS `DEUDA` from `proveedores` where ((`proveedores`.`RAZON_SOCIAL` like '%z') and (`proveedores`.`saldo` > 40000)) order by `proveedores`.`saldo` desc limit 10 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vwfacpaez`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vwfacpaez` AS select `ventas`.`Id_factura` AS `id_factura`,sum(`ventas`.`Monto_Facturado`) AS `sum(Monto_Facturado)` from `ventas` where `ventas`.`Id_factura` in (select `pedidos`.`ID_FC` from `pedidos` where (`pedidos`.`ID_CLIENTE` = 3)) group by `ventas`.`Id_factura` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2022-08-09  9:30:57
